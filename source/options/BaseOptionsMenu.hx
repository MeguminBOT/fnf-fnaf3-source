...
class BaseOptionsMenu extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		descText.setFormat(Paths.font("stalker2.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	override function update(elapsed:Float)
	{
		...
		if(nextAccept <= 0)
		{
			...
			if(controls.RESET || FlxG.mouse.justPressedMiddle #if android || virtualPad.buttonC.justPressed #end)
			{
				for (i in 0...optionsArray.length)
				{
