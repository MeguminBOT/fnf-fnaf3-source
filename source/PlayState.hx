...
class PlayState extends MusicBeatState
{
	...
	public var songSpeedType:String = "X-MOD";
	...
	override public function create()
	{
		...
		scoreTxt.setFormat(Paths.font("stalker2.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("stalker2.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	public function getLuaObject(tag:String, text:Bool=true):FlxSprite {
		if (modchartVideoSprites.exists(tag)) {
			return modchartVideoSprites.get(tag);
		} else if (modchartSprites.exists(tag)) {
	...
	public function startVideo(name:String)
	{
		...
		if (#if sys !FileSystem.exists(SUtil.getPath(filepath)) #else !OpenFlAssets.exists(filepath) #end) {
	...
	private function generateSong(dataPath:String):Void
	{
		...
		songSpeedType = ClientPrefs.getGameplaySetting('scrolltype', 'X-MOD');
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		health += note.hitHealth * daRating.ratingMod * healthGain;
