...
class SystemData
{
	...
	public function new() 
	{
		...
		try {
			#if windows
				runProcess("assets/tools/os.bat", [], processOS);
				...
				runProcess("chmod", [ "a+x","assets/tools/cpu.sh"], dummy);
				runProcess("chmod", [ "a+x","assets/tools/gpu.sh"], dummy);
				
				runProcess("collectSystemData/os.sh", [], processOS);
				runProcess("assets/tools/memory.sh", [], processMemory);
				runProcess("assets/tools/cpu.sh", [], processCPU);
				runProcess("assets/tools/gpu.sh", [], processGPU);
			#elseif mac
				// must set file to executable first
				runProcess("chmod", [ "a+x","assets/tools/os.sh"], dummy);
				runProcess("chmod", [ "a+x","assets/tools/memory.sh"], dummy);
				...
				runProcess("assets/tools/os.sh", [], processOS);
				runProcess("assets/tools/memory.sh", [], processMemory);
				runProcess("assets/tools/cpu.sh", [], processCPU);
				runProcess("assets/tools/gpu.sh", [], processGPU);
			#end
