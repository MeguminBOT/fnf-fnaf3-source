function onCreate()
	precacheImage('BGs/prefirestage');
	precacheImage('BGs/freddy');
	precacheImage('BGs/freddy2');
	precacheImage('BGs/fan');
	precacheImage('BGs/springtrap1');
	precacheImage('BGs/springtrap2');
	precacheImage('BGs/foxychase');
	precacheImage('bflighter');
	precacheImage('rarescreen1');
	precacheImage('rarescreen2');
	precacheImage('rarescreen3');
	precacheImage('characters/springtrap');
	precacheImage('characters/springtrap2');
	precacheImage('characters/springtrap3');
	precacheImage('characters/springtrap4');
	precacheImage('characters/springtrap5');
	precacheImage('characters/springtrap6');
	precacheImage('characters/springtrap7');
	precacheImage('characters/springtrap8');
	precacheImage('characters/springtrapwalk');
	precacheImage('characters/springtrapfeet');
	...
	makeVideoSprite('leftbehind', 'leftbehind', -300, -200)
	scaleVideo('leftbehind', 0.66, 0.66)
	setVideoCamera('leftbehind', 'camGame')
	setVideoScrollFactor('leftbehind', 0, 0);
...
function onStepHit()
	...
	if curStep == 3792 then
		...
		removeVideoSprite('leftbehind', true)
	end
