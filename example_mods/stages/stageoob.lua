function onCreate()
	...
	setScrollFactor('arcadeffect', 0, 0);
...
if curStep == 512 then
	...
	setScrollFactor('oobbb2', 0.8, 0.5);
...
if curStep == 1696 then
	...
	setScrollFactor('oobmangle2', 0.8, 0.5);
...
if curStep == 2752 then
	...
	setScrollFactor('oobchica2', 0.8, 0.5);
...
if curStep == 4320 then
	...
	setScrollFactor('oobfredbear2', 0, 0);
...
if curStep == 5760 then
	...
	setScrollFactor('oobpuppet2', 1, 1);
	...
	setScrollFactor('oobpuppetchild', 1, 1);
...
if curStep == 5968 then
	...
	setScrollFactor('oobpuppet5', 1, 1);
	...
	setScrollFactor('oobpuppet6', 1, 1);
	...
	setScrollFactor('oobpuppet7', 1, 1);
	...
	setScrollFactor('oobpuppet8', 1, 1);
...
if curStep == 6480 then
	...
	setScrollFactor('oobpuppet3', 1, 1);
	...
	setScrollFactor('oobpuppet4', 1, 1);
...
if curStep == 6608 then
	...
	setScrollFactor('oobpuppetchild2', 1, 1);
