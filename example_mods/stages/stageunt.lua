function onCreate()
	...
	setScrollFactor('eyes', 0.4, 0.4);

	makeLuaSprite('helloagain', 'helloagain', -400, 540);
		setScrollFactor('helloagain', 1, 1);
...
function onStepHit()
	...
	if curStep == 245 then
		...
		if curStep == 1080 then
			...
			setScrollFactor('sfedstage2', 1, 1);
